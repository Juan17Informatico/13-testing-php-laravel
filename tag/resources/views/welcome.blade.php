...
<body class="bg-gray-200 py-10">
    <div class="max-w-lg bg-white mx-auto p-5 rounded shadow">
        @if ($errors->any())
            <ul class="list-none p-4 mb-4 bg-red-100 text-red-500"f>
        ...
        <form action="tags" method="POST" class="flex mb-4">
            ...
            <input type="submit" value="Agregar" class="rounded-r px-8 bg-blue-500 text-blue-100 outline-none" >
        </form>
                ...
                <tr>
                    ...
                    <td class="px-4 py-2">
                        <form action="tags/{{ $tag->id }}" method="POST">
                            @csrf
                            @method('DELETE')
                            <input type="submit" value="Eliminar" class="px-4 rounded bg-red-500 text-red-100 text-white">
                        </form>
                    </td>
                </tr>
            @empty
